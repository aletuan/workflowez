      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
          ...
          <div className="bg-white/70 backdrop-blur-md p-8 rounded-[var(--section-radius)] border border-gray-100 hover:border-[var(--brand)]/30 transition-colors">
            ...
            <SecondaryButton href="#features" className="w-full py-4 px-6 mb-8">
          ...
          <div className="relative bg-gray-900 p-10 rounded-[var(--section-radius)] shadow-2xl shadow-[var(--brand)]/20 scale-105 z-10 text-white overflow-hidden group">
            ...
            <PrimaryButton variant="brand" href="#pricing" className="w-full py-4 px-6 mb-8">
              {t.pricing.pro.cta}
            </PrimaryButton>
            <ul className="space-y-4">
              {t.pricing.pro.features.map((feature: string) => (
                <li key={feature} className="flex items-center gap-3 text-sm font-medium text-gray-300">
                  <div className="w-5 h-5 rounded-full bg-[var(--brand)]/20 flex items-center justify-center flex-shrink-0">
